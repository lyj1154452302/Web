<?php
// http://127.0.0.1/lyj/bookstore/web/index.php/Admin/PersonalInfo/personalInfo/id/20.html
// http://127.0.0.1/lyj/bookstore/web/index.php/PersonalInfo/personalInfo/id/20.html
return array(
	//'配置项'=>'配置值'
	'DB_TYPE' => 'mysql',
	'DB_HOST' => '127.0.0.1',
	...
	'TMPL_PARSE_STRING'     =>array(
        //,自定义路径常量，用于后台样式加载
        '__ADMIN__'             =>  __ROOT__.'/Application/Admin/Common/',
        //,自定义路径常量，用于后台JS样式加载
        ...
        '__ADMININDEX__'             =>  __ROOT__.'/Application/Admin/View/Index/',

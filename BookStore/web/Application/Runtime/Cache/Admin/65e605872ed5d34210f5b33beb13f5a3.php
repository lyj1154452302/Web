...
<link rel="stylesheet" href="/lyj/bookstore/web/Application/Admin/Common/Css//user.css" type="text/css"/>
...
<script src="/lyj/bookstore/web/Application/Admin/Common/Js//deleteUser.js" type="text/javascript"></script>
</head>
    <body>
    	<div id="header">
    		<div id="Header">
    ...
    // 	}) -->
    	...
    	<div id="userform">
    		...
    		<br />
    		<?php if(is_array($userlist)): foreach($userlist as $key=>$ul_vo): ?><div class="userlist">
					<input type="checkbox" name="delete" class="list_cb"/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<span class="account"><?php echo ($ul_vo["account"]); ?></span>
					<span><?php echo ($ul_vo["username"]); ?></span>
					<span><?php echo ($ul_vo["sex"]); ?></span>
					<!-- <input type="button" value="编辑" style="color:black;"/> -->
					<a href="<?php echo U('PersonalInfo/personalInfo','id='.$ul_vo['userid']);?>" style="text-decoration:underline;" >编辑</a>
					<br />
					<br />

...
<link rel="stylesheet" href="/lyj/bookstore/web/Application/Home/Common/Css//personalInfo.css" type="text/css" />
<!-- <link rel="stylesheet" type="text/css" href="/lyj/bookstore/web/Public/jquery-confirm/website/css/bootstrap.min.css"/> -->
...
<!-- <script src="/lyj/bookstore/web/Public/jquery-confirm/jquery.confirm.js" type="text/javascript"></script> -->
<script src="/lyj/bookstore/web/Application/Home/Common/Js//changePersonalInfo.js" type="text/javascript"></script>
</head>
    <body>
    	<div id="header">
    		<div id="Header">
    ...
    // 	}) -->
    	...
    	<div id="content">
			...
			<p>
				<span class="title">用户名：</span><input type="text" name="username" value="<?php echo ($username); ?>" style="color:black;"/>
			</p>
			<p>
				<span class="title">性别：</span><span id="oriSex" style="display:none;"><?php echo ($sex); ?></span>
				<input type="radio" name="sex" value="男" />男
				<input type="radio" name="sex" value="女" />女
			</p>
			<p>
				<button id="goToChange" style="color:black;margin-left:50px;">保存</button>
			</p>
    	</div>
    </body>
</html>
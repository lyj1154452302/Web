...
<script src="/lyj/bookstore/web/Application/Home/Common/Js//personalMenu.js" type="text/javascript"></script>
    ...
    // 	}) -->
    	...
    	<div id="content">
    		<p>
    			<span class="title">账号：</span><?php echo ($account); ?>
    		</p>
			<p>
				<span class="title">用户名：</span><?php echo ($username); ?>
			</p>
			<p>
				<span class="title">性别：</span><?php echo ($sex); ?>
			</p>
			<p>
				<a href="<?php echo U('PersonalInfo/changePersonalInfo');?>"><button id="goToChange" style="color:black;margin-left:30px;">点此修改个人信息</button></a>
			</p>
    	</div>
    </body>
</html>